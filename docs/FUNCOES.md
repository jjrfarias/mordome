...
- Ver ADR 0015 para as decisões do núcleo básico. Ordem de compra e importação/matching automático de extrato bancário permanecem fora deste escopo (notas de entrada foram implementadas dentro de Estoque, ver ADR 0020).
