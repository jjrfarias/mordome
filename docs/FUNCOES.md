...
- Ver ADR 0015 para as decisões do núcleo básico. Ordem de compra/notas de entrada e importação/matching automático de extrato bancário permanecem fora deste escopo.
