...
export async function getCurrentSession() {
  ...
  return {
    ...
    canManageCustomers: hasPermission(permissionContext, CUSTOMERS_MANAGE),
    canManageFiscal: hasPermission(permissionContext, FISCAL_MANAGE),
    printerDriver,
    printTemplate,
  };
}
